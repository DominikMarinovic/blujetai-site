...
const stats: Stat[] = [
  ...
  },
  {
    ...
    blurb: "Get more revenue from the same amout of existing traffic",
  },
  {
    stat: "75,000+",
    label: "Calls Made",
  ...
  },
  {
    ...
    blurb: "Proactive rebill recovery reduces avoidable churn and saves MRR.",
  },
]

export default function StatsStrip() {
  return (
    <section aria-labelledby="stats-heading" className="container bg-white py-10 sm:py-12">
      <h2 id="stats-heading" className="sr-only">
        Proof points
      </h2>
      {/* Non-linear layout: staggered individual cards instead of one straight strip */}
      <div className="grid text-center grid-cols-1 gap-4 sm:gap-6 md:grid-cols-2 lg:grid-cols-4">
        {stats.map((s, i) => (
          <div
            key={s.label}
            className={
          ...
          >
            <div className="text-3xl sm:text-4xl font-extrabold tracking-tight text-stone-900">
              {s.stat}
            </div>
